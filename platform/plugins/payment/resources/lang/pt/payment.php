...
return [
    ...
    'update' => 'Atualizar',
    'configuration_instruction' => 'Instruções de configuração para :name',
    'configuration_requirement' => 'Para usar :name, precisa de',
    'service_registration' => 'Registe-se em :name',
    'after_service_registration_msg' => 'Depois de se registar em :name, terá um Client ID e Client Secret',
    ...
    'stripe_after_service_registration_msg' => 'Depois de se registar em :name, receberá as chaves pública e secreta',
    ...
    'payment_description' => 'Pagamento da encomenda #:order_id em :site_url',
    'payment_log' => [
    ...
    'could_not_get_stripe_payment_details' => 'Não foi possível obter os detalhes do pagamento Stripe.',
    'payment_logs' => 'Registos de pagamento',
    'request_data' => 'Dados do pedido',
    ...
    'fee_type' => 'Tipo de taxa de processamento (opcional)',
    'fee_type_helper' => 'Escolha como a taxa deve ser calculada: um valor fixo ou uma percentagem do total da encomenda. Se optar por um valor fixo, este utilizará a moeda padrão (:currency).',
];
