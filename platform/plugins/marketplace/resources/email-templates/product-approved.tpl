        ...
        <tbody>
            <tr>
                <td class="bb-content bb-pb-0" align="center">
                    ...
                    <h1 class="bb-text-center bb-m-0 bb-mt-md">{{ 'plugins/marketplace::marketplace.email_templates.product_approved_title' | trans }}</h1>
                </td>
            </tr>
            <tr>
                <td class="bb-content bb-pb-0">
                    <p>{{ 'plugins/marketplace::marketplace.email_templates.dear_vendor' | trans({'vendor_name': store_name}) }}</p>
                    <div>{{ 'plugins/marketplace::marketplace.email_templates.product_approved_message' | trans({'site_url': site_url}) | raw }}</div>
                </td>
            </tr>
            <tr>
