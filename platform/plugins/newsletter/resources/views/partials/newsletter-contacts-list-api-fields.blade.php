...
>
    ...
    >
        ...
        <p class="mb-0">{!! trans('plugins/newsletter::newsletter.settings.mailchimp_api_key_instruction') !!}</p>
    </x-core::alert>
    ...
    >
        ...
        <p class="mb-0">{!! trans('plugins/newsletter::newsletter.settings.sendgrid_api_key_instruction') !!}</p>
    </x-core::alert>
