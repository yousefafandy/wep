    ...
    >
        <div class="row">
            <div class="col-md-6 mb-3 position-relative">
                <label class="form-label required">{{ __('order.name') }}</label>
                <input type="text" class="form-control" v-model="address.name" />
            </div>
            <div class="col-md-6 mb-3 position-relative">
                <label class="form-label required">{{ __('order.phone') }}</label>
                <input type="text" class="form-control" v-model="address.phone" />
            </div>
            <div class="col-md-6 mb-3 position-relative">
                <label class="form-label required">{{ __('order.address') }}</label>
            ...
            <div class="col-md-6 mb-3 position-relative">
                <label class="form-label required">{{ __('order.state') }}</label>
                <select
            ...
            <div class="col-md-6 mb-3 position-relative">
                <label class="form-label required">{{ __('order.city') }}</label>
                <select
                    v-if="use_location_data"
